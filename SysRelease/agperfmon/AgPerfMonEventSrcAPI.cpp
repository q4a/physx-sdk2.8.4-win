...
AgPmHANDLE AgPmCreateSourceConnection()
{
	...
	AgPmHANDLE handle = createFunc(AG_PERFMON_VERSION);
	if (!handle)
	{
		MessageBoxA(NULL, "The AGEIA PerfMON DLL was not able to load properly, PerfMON is disabled.", "AGEIA PerfMON ERROR", MB_OK|MB_ICONSTOP);
