...
enum NxBroadPhaseType
{
	...
	*/
	...
	/**
	\brief A multi sweep-and-prune algorithm to find pairs of potentially colliding shapes running on SPUs.
...
enum NxSceneFlags
	...
	*/
	...
	while limiting the number of actors (see "PhysX Hardware Scenes" in the Guide).
...
class NxSceneDesc
	...
	*/
	...
	/**
	\brief Defines the broadphase origin.
...
NX_INLINE void NxSceneDesc::setToDefault()
	...
	nbGridCellsX			= 0;
	nbGridCellsY			= 0;
	bpOrigin                = NxVec3(0.0f, -0.2f, 0.0f);
