...
The NVIDIA PhysX SDK users guide describes which shapes that can collide with each other (direct link: <a href="PhysXDocumentation.chm::/Guide/collision_Interactions.html">users guide</a>)
