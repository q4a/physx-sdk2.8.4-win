...
// -------------------------------------------------------------------------------------
void MeshHash::setGridSpacing(m3Real spacing)
{
	mSpacing = spacing;
...
// -------------------------------------------------------------------------------------
void MeshHash::add(const m3Bounds &bounds, int itemIndex)
{
	int x1,y1,z1;
	int x2,y2,z2;
	int x,y,z;
...
// -------------------------------------------------------------------------------------
void MeshHash::add(const m3Vector &pos, int itemIndex)
{
	int x,y,z;
...
// ----------------------------------------------------------------------------------------------------------
void MeshHash::query(const m3Bounds &bounds, std::vector<int> &itemIndices, int maxIndices)
{
	int x1,y1,z1;
	int x2,y2,z2;
	int x,y,z;
...
// -------------------------------------------------------------------------------------
void MeshHash::queryUnique(const m3Bounds &bounds, std::vector<int> &itemIndices, int maxIndices)
{
...
// ----------------------------------------------------------------------------------------------------------
void MeshHash::query(const m3Vector &pos, std::vector<int> &itemIndices, int maxIndices)
{
	int x,y,z;
	cellCoordOf(pos, x,y,z);
	itemIndices.clear();
...
// -------------------------------------------------------------------------------------
void MeshHash::queryUnique(const m3Vector &pos, std::vector<int> &itemIndices, int maxIndices)
{
