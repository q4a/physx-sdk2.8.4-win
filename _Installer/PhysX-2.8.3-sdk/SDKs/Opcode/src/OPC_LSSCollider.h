...
//		float		FatRadius2;	//!< LSS used when performing the query resulting in cached faces
	...
	class OPCODE_API LSSCollider : public VolumeCollider
	{
		...
		inline_				BOOL			LSSAABBOverlap(const OpcSimd::Vector4& center, const OpcSimd::Vector4& extents);
#endif
		...
		inline_				BOOL			LooseLSSTriOverlap(const Point& vert0, const Point& vert1, const Point& vert2);
