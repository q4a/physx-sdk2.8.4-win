...
#define __ICEOBB_H__
	...
	// For CCT Big Worlds
	class ICEMATHS_API BigOBB
	{
		public:
		//! Constructor
		inline_						BigOBB()		{}
		//! Constructor
		inline_						BigOBB(const BigPoint& center, const Point& extents, const Matrix3x3& rot) : mCenter(center), mExtents(extents), mRot(rot)	{}
		//! Destructor
		inline_						~BigOBB()		{}

				BigPoint			mCenter;		//!< B for Box
				Point				mExtents;		//!< B for Bounding
				Matrix3x3			mRot;			//!< O for Oriented
	};
