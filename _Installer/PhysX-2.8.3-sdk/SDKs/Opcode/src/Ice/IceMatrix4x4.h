...
//				Matrix&	ComputeAxisMatrix(Point& axis, float angle);
	...
	*	NOTE: It is important to inline this for good code gen on 360(OBB collider). So the compiler
	*	can en-register variables.
	*
	*	\relates	Matrix4x4
	...
	*/
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	inline_ void InvertPRMatrix(Matrix4x4& dest, const Matrix4x4& src)
	{
