...
#define __ICESEGMENT_H__
	...
	// For CCT Big Worlds
	class ICEMATHS_API BigSegment
	{
		public:
		//! Constructor
		inline_					BigSegment()															{}
		//! Constructor
		inline_					BigSegment(const BigPoint& p0, const BigPoint& p1) : mP0(p0), mP1(p1)	{}
		//! Copy constructor
		inline_					BigSegment(const BigSegment& seg) : mP0(seg.mP0), mP1(seg.mP1)			{}
		//! Destructor
		inline_					~BigSegment()															{}

						BigPoint	mP0;		//!< Start of segment
						BigPoint	mP1;		//!< End of segment
	};
