...
//#ifdef TIWAK_BIG_WORLDS
	#define BigType			double
	#define PruningAABB		BigAABB
	#define PruningOBB		BigOBB
	#define PruningLSS		BigLSS
	#define PruningSphere	BigSphere
	#define PruningRay		BigRay
	#define PruningSegment	BigSegment
/*#else
	#define BigType			float
	#define BigPoint		Point
	#define PruningAABB		AABB
	#define PruningOBB		OBB
	#define PruningLSS		LSS
	#define PruningSphere	Sphere
	#define PruningRay		Ray
	#define PruningSegment	Segment
#endif*/
