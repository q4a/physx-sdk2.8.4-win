...
class ICECORE_API ContainerSizeT : public Allocateable
	{
		public:
		// Constructor / Destructor
								ContainerSizeT();
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				void			InitSharedBuffers(udword max_entries, size_t* entries);
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	ContainerSizeT&		Add(size_t entry)
								{
									// Resize if needed
									if(mCurNbEntries==mMaxNbEntries)	Resize();
		...
		//! Add unique [slow]
		inline_	ContainerSizeT&		AddUnique(size_t entry)
								{
									if(!Contains(entry))	Add(entry);
									return *this;
								}								
		...
		inline_	void			DeleteIndex(udword index)				{ mEntries[index] = mEntries[--mCurNbEntries];	}
				...
				udword			DeleteKeepingOrder(size_t entry);

		// Data access.
		inline_	udword			GetNbEntries()					const	{ return mCurNbEntries;					}	//!< Returns the current number of entries.
		inline_	udword			GetMaxNbEntries()				const	{ return mMaxNbEntries;					}	//!< Returns max number of entries before resizing.
		inline_	size_t			GetEntry(udword i)				const	{ return mEntries[i];					}	//!< Returns ith entry.
		inline_	size_t*			GetEntries()					const	{ return mEntries;						}	//!< Returns the list of entries.
