...
#define OPC_HYBRIDMODEL_H
	...
	//! Leaf descriptor
	class LeafTriangles : public Allocateable
	{
		public:
		inline_			LeafTriangles()		{}
		inline_			~LeafTriangles()	{}
	...
	ICE_COMPILE_TIME_ASSERT(sizeof(LeafTriangles)==4);
	...
	class OPCODE_API HybridModel : public BaseModel
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		override(BaseModel)	bool					Save(bool mismatch, CustomArray& array)	const;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		override(BaseModel)	bool					Load(const Stream& stream);
