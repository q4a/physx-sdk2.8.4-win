...
//									Epsilon	= 0.001f;
	...
	class MESHMERIZER_API Adjacencies : public Allocateable
	{
		...
		// PT: completely experimental version to improve HW mesh cooker
				bool				Walk2(WALK_CALLBACK callback, void* user_data, const Point* verts, const IndexedTriangle* tris);
		// Helpers
				udword				ComputeNbBoundaryEdges() const;
#ifdef MSH_ADJACENCIES_INCLUDE_TOPOLOGY
...
//#ifdef NX_COOKING
	class MESHMERIZER_API AdjacenciesBuilder : public Adjacencies
	{
		public:
		// Constructor / destructor
									AdjacenciesBuilder();
