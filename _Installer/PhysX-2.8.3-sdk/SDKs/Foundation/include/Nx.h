...
*/
	...
	#elif defined(CAFE)
		#define NX_CALL_CONV
	#elif defined(__native_client__) || defined(__flash__) || defined(__webgl__)
        #define NX_CALL_CONV
...
//@L this elif here originally was totally wrong.
#if !defined __CELLOS_LV2__
	#if defined(NX64) && defined(LINUX)
		#define NX_COMPILE_TIME_ASSERT(exp)	extern char NX_CompileTimeAssert[ uint((exp) ? 1 : -1) ]
	#else
