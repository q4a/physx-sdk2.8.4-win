#ifndef NX_FOUNDATION_NXMATH_WIIU
#define NX_FOUNDATION_NXMATH_WIIU
/*----------------------------------------------------------------------------*\
|
...
asm float NxMath_recip_asm (float arg)
{
%reg arg
	fres f0, arg
}

NX_INLINE NxF32 NxMath::recip(register NxF32 a)
{
	register float r = NxMath_recip_asm (a);
	return r;
}
