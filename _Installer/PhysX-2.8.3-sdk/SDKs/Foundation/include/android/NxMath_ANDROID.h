#ifndef NX_FOUNDATION_NXMATH_ANDROID
#define NX_FOUNDATION_NXMATH_ANDROID
/*----------------------------------------------------------------------------*\
|
...
{
	return (0 == ( (FP_INFINITE | FP_NAN) & ::__fpclassifyf(f) ));
}

NX_INLINE bool NxMath::isFinite(NxF64 f)
{
	return (0 == ( (FP_INFINITE | FP_NAN) & ::__fpclassifyd(f) ));
}
