#ifndef NX_FOUNDATION_NXMATH_WII
#define NX_FOUNDATION_NXMATH_WII
/*----------------------------------------------------------------------------*\
|
...
// Type conversion and rounding
		...
		*/
		...
		\brief reciprocal.
		*/
		NX_INLINE static NxF32 recip(NxF32 a);
		/**
		\brief Square root.
		*/
...
NX_INLINE NxF32 NxMath::sign(NxF32 a)
	{
	//Although we can get the sign from sign bit of float, but it need a read/store opt
...
NX_INLINE NxF32 NxMath::recip(NxF32 a)
{
	register float fa = a,r;
	asm	{ fres r, fa}
	return r;
}
...
NX_INLINE NxF32 NxMath::recipSqrt(NxF32 a)
	{
		...
		{ 
			...
			fnmsubs	nwork0, nwork0, fa, c_three;
...
NX_INLINE NxF64 NxMath::recipSqrt(NxF64 a)
	{
		register NxF64	r,fa = a, 
						nwork0, nwork1, 
						c_half = 0.5, c_three = 3.0;
