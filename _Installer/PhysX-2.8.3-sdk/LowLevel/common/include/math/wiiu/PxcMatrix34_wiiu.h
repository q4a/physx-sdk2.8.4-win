#ifndef PXC_MATRIX34_WIIU_H
#define PXC_MATRIX34_WIIU_H
...
//		set(other.rotation);
	...
	PXD_FORCE_INLINE PxcVector rotate(const PxcVector& other) const
	{
		Mtx m;
		PxcVector v;
		m[0][0] = (*this)[0][0]; m[0][1] = (*this)[1][0]; m[0][2] = (*this)[2][0]; m[0][3] = 0;
		m[1][0] = (*this)[0][1]; m[1][1] = (*this)[1][1]; m[1][2] = (*this)[2][1]; m[1][3] = 0;
		m[2][0] = (*this)[0][2]; m[2][1] = (*this)[1][2]; m[2][2] = (*this)[2][2]; m[2][3] = 0;
		
		MTXMultVec( m, (Vec*)&other.x, (Vec*)&v.x);
		return v;		
	}
