...
#ifdef __PPCGEKKO__
	float centerY = height-radius-spacing-16;
#else
...
#ifdef __PPCGEKKO__
		centerX = i<4?spacing + wheelRpmRadius:(spacing + wheelRpmRadius)*2.2;
		centerY = i<4?spacing + 58+ wheelRpmRadius + i*(2*wheelRpmRadius + 2):(spacing + 58 + wheelRpmRadius + (i-4)*(2*wheelRpmRadius + 2));
#else
